...
<template>
  <div style="background-color: #0C0923;">
      ...
      <div class="back">
        ...
        <span class="text22"><span>STAFFS</span></span>
      </div>
    </div>
  </div>
</template>
