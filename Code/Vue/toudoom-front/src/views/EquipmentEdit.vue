          ...
          <div class="col-9">
            ...
            <div class="container" style="margin-left:4%">
              <table class="table table-striped table-hover" style="color: white">
                <div class="row">
                  <div class="col" style="background-color: #110C36;margin-right: 1%; height: 270px; border-radius: 15px 15px 15px 15px">
                ...
                <div class="col" style="background-color: #110C36; margin-right: 0%; height: 270px; border-radius: 15px 15px 15px 15px;margin-top: 3%; margin-left: -1%;">
...
export default {
  ...
  methods: {
    ...
    async getAllProjects() {
      let list = await this.$http.get("http://localhost:9000/toudoomapi/equipment/edit");
