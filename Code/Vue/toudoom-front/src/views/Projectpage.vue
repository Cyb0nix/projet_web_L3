              ...
              >
                <div>
                  ...
                  <div class="row">
                    <div class="col mb-2 info-name">
                      Start Date :
                      <span class="info">{{ project.startingDate.split("T")[0] }}</span>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col mb-2 info-name">
                      End Date :
                      <span class="info">{{ project.endingDate.split("T")[0] }}</span>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col mb-2 info-name">
                  ...
                  <div class="row" v-if="project.isPaid">
                    <div class="col mb-2 info-name">
                      Benefits : <span class="info">{{ project.benefits + "€" }}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                >
                  <thead>
                    ...
                    <tr
                      ...
                      @click="openEquipment(e.equipmentID)"
                    >
                      <td>{{ e.equipmentID }}</td>
                      <td>{{ e.name }}</td>
                      <td>{{ e.type }}</td>
